...
export type PlayerFragment = { __typename?: 'GamePlayerModel', id: string, status: Types.GamePlayerStatus, virtual?: string | null, role: { __typename?: 'RoleModel', description: string, enum: Types.Roles, id: string, name: string, point: number, side: Types.RoleSide, status: Types.Status } };

export type ActionFragment = { __typename?: 'GameRoundActionModel', booleanResult?: boolean | null, id: string, statusResult?: Types.GamePlayerStatus | null, turnOf: Types.Roles, target: { __typename?: 'GamePlayerModel', id: string, virtual?: string | null } };

export type RoundFragment = { __typename?: 'GameRoundModel', id: string, sequence: number, time: Types.GameRoundTime, actions: Array<{ __typename?: 'GameRoundActionModel', booleanResult?: boolean | null, id: string, statusResult?: Types.GamePlayerStatus | null, turnOf: Types.Roles, target: { __typename?: 'GamePlayerModel', id: string, virtual?: string | null } }> };

export type GameFragment = { __typename?: 'GameModel', id: string, roomId: number, status: Types.GameStatus, players: Array<{ __typename?: 'GamePlayerModel', id: string, status: Types.GamePlayerStatus, virtual?: string | null, role: { __typename?: 'RoleModel', description: string, enum: Types.Roles, id: string, name: string, point: number, side: Types.RoleSide, status: Types.Status } }>, rounds: Array<{ __typename?: 'GameRoundModel', id: string, sequence: number, time: Types.GameRoundTime, actions: Array<{ __typename?: 'GameRoundActionModel', booleanResult?: boolean | null, id: string, statusResult?: Types.GamePlayerStatus | null, turnOf: Types.Roles, target: { __typename?: 'GamePlayerModel', id: string, virtual?: string | null } }> }>, abilities: Array<{ __typename?: 'GameAbilityModel', abilityId: string, gameId: string, id: string, totalUses: number, usesThisRound: number, ability: { __typename?: 'RoleAbilityModel', description: string, id: string, name: string, roleId: string, totalUses: number, usesPerRound: number } }> };
...
export type CreateRoundMutation = { __typename?: 'Mutation', createRound: { __typename?: 'ErrorOutput', message: string } | { __typename?: 'GameRoundModel_Mutation', message: string, data: { __typename?: 'GameRoundModel', id: string, sequence: number, time: Types.GameRoundTime, actions: Array<{ __typename?: 'GameRoundActionModel', booleanResult?: boolean | null, id: string, statusResult?: Types.GamePlayerStatus | null, turnOf: Types.Roles, target: { __typename?: 'GamePlayerModel', id: string, virtual?: string | null } }> } } };
...
export type CreateGameRoundActionMutation = { __typename?: 'Mutation', createGameRoundAction: { __typename?: 'ErrorOutput', message: string } | { __typename?: 'GameRoundActionModel_Mutation', message: string, data: { __typename?: 'GameRoundActionModel', booleanResult?: boolean | null, id: string, statusResult?: Types.GamePlayerStatus | null, turnOf: Types.Roles, target: { __typename?: 'GamePlayerModel', id: string, status: Types.GamePlayerStatus, virtual?: string | null, role: { __typename?: 'RoleModel', description: string, enum: Types.Roles, id: string, name: string, point: number, side: Types.RoleSide, status: Types.Status } } } } };
